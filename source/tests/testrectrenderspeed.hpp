...
class Test_RectRenderSpeed: public State{
    public:
        Test_RectRenderSpeed():State(){
        ...
        ~Test_RectRenderSpeed(){

        };
        void Begin(){
            ScreenManager::GetInstance().SetScreenName("Test Rect Render Speed");
        };
        ...
        void Render(){
            ...
            for (int i=0;i<state;i++){
                ...
                //for (int a=1;a<10;a++){
                    //tiles.Render(Point(  )) ;
                    RenderHelp::DrawSquareColor(Rect((i % 60) * 16, (i/60)*16,16,16),i%255,120,255 - (i%255),255);
                //}
            }
