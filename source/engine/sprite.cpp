...
int Sprite::GetWidth(){
    return size.x*m_renderData.m_scale.x;
}

int Sprite::GetHeight(){
    return size.y*m_renderData.m_scale.y;
}
int Sprite::GetFrameHeight(){
    return m_renderData.m_clip.h*m_renderData.m_scale.y;
}

int Sprite::GetFrameWidth(){
    return m_renderData.m_clip.w*m_renderData.m_scale.x;
}
